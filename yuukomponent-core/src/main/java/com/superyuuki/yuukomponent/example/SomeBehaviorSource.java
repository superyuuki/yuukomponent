...
import com.superyuuki.yuukomponent.core.inbuilt.stat.types.IntegerStat;
...
public class SomeBehaviorSource implements BehaviorSource {
    ...
    public Behavior instantiate(UUID uuid) {
        ...
        Stat<Integer> damage = new IntegerStat(dispatcher, uuid, 0); //calculations start at 0
        Stat<Integer> range = new IntegerStat(dispatcher, uuid, defaultDamage); //range starts off as 5 if called by this behavior
