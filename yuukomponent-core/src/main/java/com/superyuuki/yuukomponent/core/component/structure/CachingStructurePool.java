...
import com.superyuuki.yuukomponent.api.component.structure.TxStructurePool;
...
public class CachingStructurePool implements TxStructurePool {

    private final TxStructurePool delegate;

    private final Cache<UUID, List<UUID>> childrenCache;
    private final Cache<UUID, Optional<UUID>> parentCache;

    public CachingStructurePool(TxStructurePool delegate, Duration cachingExpiry) {
