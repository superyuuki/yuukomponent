...
public class CachingStructurePool implements StructurePool {

    private final StructurePool delegate;

    private final Cache<UUID, List<UUID>> childrenCache;
    private final Cache<UUID, Optional<UUID>> parentCache;

    public CachingStructurePool(StructurePool delegate, Duration cachingExpiry) {
